...
@Suite
@SelectClasses([ MNodeSecurityTests.class, PasswordHasherTests.class, ShiroAuthenticationTests.class, CacheFacadeTests.class, EntityCrud.class, EntityFindTests.class, EntityNoSqlCrud.class,
